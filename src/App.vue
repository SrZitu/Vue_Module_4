...
const tasks = [
  ...
  { id: 4, title: "Prepare presentation slides", status: "Completed" },
  { id: 5, title: "Test new feature implementation", status: "Pending" },
];
...
//v,k,i here v=value ,k=property, and i=index
...
function getTasksInProgress(){
  ...
  //writing with anonymous function
